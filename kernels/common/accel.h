...
public:
    ...
    /*! notifies the acceleration structure about the deletion of some
        geometry */
...
public:
    ...
    typedef void (*IntersectFunc4)(
        const void* valid,  /*!< pointer to valid mask */
        Intersectors* This, /*!< this pointer to accel */
