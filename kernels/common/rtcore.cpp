...
RTC_API void
rtcSetDeviceProperty(RTCDevice hdevice,
                     const RTCDeviceProperty prop,
                     ssize_t val)
{
    Device* device = (Device*) hdevice;
    RTC_CATCH_BEGIN;
...
RTC_API void
rtcSetDeviceErrorFunction(RTCDevice hdevice,
...
RTC_API void
rtcSetDeviceMemoryMonitorFunction(RTCDevice hdevice,
...
RTC_API RTCBuffer
rtcNewBuffer(RTCDevice hdevice, size_t byteSize)
{
    RTC_CATCH_BEGIN;
...
RTC_API RTCBuffer
rtcNewSharedBuffer(RTCDevice hdevice, void* ptr, size_t byteSize)
{
    RTC_CATCH_BEGIN;
...
// Entry point of the library. Intersects one ray with the scene.
RTC_API void
rtcIntersect1(RTCScene hscene,
